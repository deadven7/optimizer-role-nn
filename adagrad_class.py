...
class ADA_TrainTest:
    def __init__(self, batch_size=64, test_batch_size=1000, epochs=10, lr=0.01, seed=1, log_interval=10, save_model=False, ratio=0.5):
    ...
    def NN_model(self):
        ...
        if self.save_model:
            torch.save(self.model.state_dict(), "mnist_LeNet-5_adagrad.pt")
